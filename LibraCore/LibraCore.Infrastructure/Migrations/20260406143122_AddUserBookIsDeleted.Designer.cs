...
namespace LibraCore.Infrastructure.Migrations
{
    ...
    [Migration("20260406143122_AddUserBookIsDeleted")]
    partial class AddUserBookIsDeleted
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraCore.Infrastructure.Data.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDI23fbkbCm+jX4u5W7m1O9gruik8omVn0ni9J8w7ee86fUfFzYQNLoR15kQjLxKUg==",
                        ...
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFm9P7KOZAKQ3UYtx6SRnqrYDVWQxnMWdtDPJmcJxlldRWoQYqJpSvarlGCQr6SfAg==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("LibraCore.Infrastructure.Data.Entities.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f1d8e8b0-5001-4b2f-8a0a-000000000501"),
                            BookId = new Guid("d1b8e8b0-3001-4b2f-8a0a-000000000301"),
                            Comment = "A timeless classic — thoroughly enjoyed it.",
                            IsDeleted = false,
                            Rating = 5,
                            UserId = new Guid("c1d8e8b0-2001-4b2f-8a0a-000000000201")
                        },
                        new
                        {
                            Id = new Guid("f1d8e8b0-5002-4b2f-8a0a-000000000502"),
                            BookId = new Guid("d1b8e8b0-3002-4b2f-8a0a-000000000302"),
                            Comment = "Well written with memorable characters.",
                            IsDeleted = false,
                            Rating = 4,
                            UserId = new Guid("c1d8e8b0-2002-4b2f-8a0a-000000000202")
                        },
                        new
                        {
                            Id = new Guid("f1d8e8b0-5003-4b2f-8a0a-000000000503"),
                            BookId = new Guid("d1b8e8b0-3004-4b2f-8a0a-000000000304"),
                        ...
                        new
                        {
                            Id = new Guid("f1d8e8b0-5004-4b2f-8a0a-000000000504"),
                            BookId = new Guid("d1b8e8b0-3006-4b2f-8a0a-000000000306"),
                        ...
                        new
                        {
                            Id = new Guid("f1d8e8b0-5005-4b2f-8a0a-000000000505"),
                            BookId = new Guid("d1b8e8b0-3007-4b2f-8a0a-000000000307"),
                        ...
                        new
                        {
                            Id = new Guid("f1d8e8b0-5006-4b2f-8a0a-000000000506"),
                            BookId = new Guid("d1b8e8b0-3008-4b2f-8a0a-000000000308"),
            ...
            modelBuilder.Entity("LibraCore.Infrastructure.Data.Entities.UserBook", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = new Guid("c1d8e8b0-2002-4b2f-8a0a-000000000202"),
                            BookId = new Guid("d1b8e8b0-300a-4b2f-8a0a-00000000030a"),
                            IsDeleted = false
                        },
                        new
                        {
                            UserId = new Guid("c1d8e8b0-2002-4b2f-8a0a-000000000202"),
                            BookId = new Guid("d1b8e8b0-3009-4b2f-8a0a-000000000309"),
                            IsDeleted = false
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e1d8e8b0-4001-4b2f-8a0a-000000000401"),
                        ...
                        new
                        {
                            Id = new Guid("e1d8e8b0-4002-4b2f-8a0a-000000000402"),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = new Guid("c1d8e8b0-2001-4b2f-8a0a-000000000201"),
                            RoleId = new Guid("e1d8e8b0-4001-4b2f-8a0a-000000000401")
                        },
                        new
                        {
                            UserId = new Guid("c1d8e8b0-2002-4b2f-8a0a-000000000202"),
                            RoleId = new Guid("e1d8e8b0-4002-4b2f-8a0a-000000000402")
                        });
                });
